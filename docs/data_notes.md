...
| D6 | **Total do pedido 3 ≠ soma dos itens** (R$ 3.450 vs 2 × R$ 1.749 = R$ 3.498) | orders.csv / order_items.csv | Preservado; o total gravado do pedido é a fonte de verdade do pedido (pode refletir desconto aplicado na época) | `test_order_3_total_mismatch_is_preserved` |
